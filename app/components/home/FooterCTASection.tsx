...
import CopyWriteStrip from "../shared/CopywriteStrip"
    ...
    <section className="footer-cta-section">
      <div className="footer-cta-wrapper">
        <div className="section-header">
          <h2 className="gilroy_bold heading">Grow Smarter, Sell Faster - with</h2>
        </div>
        <div className="logo-block">
          <div className="logo">
            <svg id="logo" xmlns="http://www.w3.org/2000/svg" width="228.676" height="64.917" viewBox="0 0 228.676 64.917">
              <path id="Path_16" data-name="Path 16" d="M108.584.124A45.015,45.015,0,0,1,94.451,2.781H10.257A10.256,10.256,0,0,0,0,13.039V54.382A10.257,10.257,0,0,0,10.257,64.639h59.2V54.17L59.1,32.362l-.49-1-.4-.846-2.072-4.321h10.4l7.106,18.422h.023l.312.8s1.982-5.7,2.673-7.328c1.224-2.963,5.279-11.895,5.279-11.895L85,28.858l-1.348,2.47,1.43.78,1.263-2.081,2.76,2.4-2.539,4.722L84,42.587a56.125,56.125,0,0,0-5.435,22.052H97.8a10.257,10.257,0,0,0,10.257-10.257V16.358A37.856,37.856,0,0,1,110.84,2.434a1.762,1.762,0,0,0-2.256-2.31M29.448,39.37H17.731V54.117h-8.8V21.372h8.8v10H29.448ZM35.262,21.3H20.716V13.331H35.261Zm24,24.82L63.05,54.1H40.687V13.313h8.8V46.124Z" transform="translate(0 0.001)" fill="#ffffff"/>
              <path id="Path_17" data-name="Path 17" d="M39.382,15.455l-1.375-.719-1.44,3.041,1.261.606Z" transform="translate(44.886 18.088)" fill="#ffffff"/>
              <path id="Path_18" data-name="Path 18" d="M35.685,19.888l1.078.454,1.408-3-1.2-.554Z" transform="translate(43.804 20.609)" fill="#ffffff"/>
              <path id="Path_19" data-name="Path 19" d="M34.911,22.05l.887.319L37.05,19.29l-1.016-.405Z" transform="translate(42.853 23.18)" fill="#ffffff"/>
              <path id="Path_20" data-name="Path 20" d="M34.259,24.238l.684.2,1.071-3.145-.818-.277Z" transform="translate(42.053 25.806)" fill="#ffffff"/>
              <path id="Path_21" data-name="Path 21" d="M33.747,26.476l.472.1.864-3.214-.615-.164Z" transform="translate(41.426 28.47)" fill="#ffffff"/>
              <path id="Path_22" data-name="Path 22" d="M33.4,28.72l.252.033.61-3.268-.4-.078Z" transform="translate(41.005 31.187)" fill="#ffffff"/>
              <path id="Path_23" data-name="Path 23" d="M33.266,30.982h.024l.3-3.327-.176-.018Z" transform="translate(40.834 33.934)" fill="#ffffff"/>
              <path id="Path_24" data-name="Path 24" d="M93.412,5.021H71.587V50.09h29.229V41.269H81.308V31.675H94.573V23.048H81.308V13.842h19.509V5.014h-7.4Z" transform="translate(87.874 6.155)" fill="#1511B1"/>
          ...
          <div className="avatar">
            <Image src={'/images/cta-avatar.png'} alt="CTA Avatar" fill />
          </div>
        </div>
        <div className="cta-button">
          <Link href={'/register'} className="button button--accent" data-icon="end">
            <span>Ready to Fly Together?</span>
            <span className="icon">
              <i className="fa-solid fa-arrow-right"></i>
            </span>
          </Link>
          <div className="strip-start"></div>
        </div>
      </div>
